...
-- Daily activity table (aggregated by day + difficulty)
CREATE TABLE daily_activity (
    ...
    difficulty TEXT NOT NULL DEFAULT 'unknown',  -- 'easy', 'medium', 'hard', or 'unknown' for legacy rows
    ...
    CONSTRAINT difficulty_check CHECK(difficulty IN ('easy', 'medium', 'hard', 'unknown')),
    UNIQUE(user_id, activity_date, module, difficulty)
);
...
CREATE INDEX idx_daily_activity_user_module_diff ON daily_activity(user_id, module, difficulty);
